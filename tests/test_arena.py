...
@pytest.fixture
def client():
    """Create a TestClient with mocked ppmlx modules for server tests."""
    _mock_engine = MagicMock()
    _mock_engine.generate.return_value = ("Hello!", None, 10, 5)
    _mock_engine.stream_generate.return_value = iter(["Hello"])
    _mock_engine.list_loaded.return_value = []
    ...
    _mock_db = MagicMock()
    _mock_db.get_stats.return_value = {"total_requests": 0, "avg_duration_ms": None, "by_model": []}
